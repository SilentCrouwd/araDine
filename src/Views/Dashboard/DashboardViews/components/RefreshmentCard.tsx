...
function RefreshmentCard({
  ...
  return (
      <div className="refreshment-card w-fit h-60 flex flex-col justify-center  border border-border rounded-xl m-2 bg-card-foreground/25 ">
        ...
        <div className="flex flex-col gap-2">
          <div className="gap-1 py-3 px-6">
            <p>Date: {date}</p>
            <p>
              Time: {startTime} - {endTime} <p>Room: {room}</p>
            </p>
          </div>
