...
function Login() {
  return (
    <form
      className="card mx-auto mt-45 flex w-full max-w-md flex-col gap-6 rounded-lg border border-border p-6"
      action="#"
      method="post"
    >
      <div>
      ...
      <p className="text-center text-sm text-muted">
        Noch kein Konto?{" "}
        <Link to="../signup/kunde" className="text-primary hover:underline">
          Jetzt registrieren
        </Link>
      </p>
    </form>
